<template>
  <div id="app">
    ...
    <b-card no-body>
      ...
      <b-card-body id="nav-scroller" ref="content" style="position:relative; height:100%; overflow-y:auto;">
        <!-- <p>{{ text }}</p>
        <h4 id="fat">@fat</h4>
        ...
        <b-row>
          <b-col>
            <b-link size="sm" href="#/">Home</b-link>
          </b-col>
          <b-col>
            <b-link size="sm" href="#/about">About</b-link>
          </b-col>
          <b-col>
            <b-link size="sm" href="#/contact">Contact Us</b-link>
          </b-col>
        </b-row>
